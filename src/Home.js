            ...
            <div id="body">
                ...
                <div className=" card text-center  bg-dark text-white">
                    ...
                    <div className="mx-3 mb-3 my-3">
                        <a className="btn btn-outline-primary mx-3 bg-dark text-white  my-3" href="/About">About Me</a>
                        <a className="btn btn-outline-primary my-3 bg-dark text-white" href="/Contact">Contact</a>
